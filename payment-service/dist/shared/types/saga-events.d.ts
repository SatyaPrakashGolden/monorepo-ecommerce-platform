...
export type SagaEventType = OrderCreationStartedEvent | OrderCreatedEvent | OrderCreationFailedEvent | PaymentProcessingStartedEvent | PaymentVerifiedEvent | PaymentFailedEvent | OrderCompletedEvent | OrderFailedEvent | PaymentReversalRequestedEvent | PaymentReversedEvent | OrderCancellationRequestedEvent;
